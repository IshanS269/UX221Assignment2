...
<p class="has-text-align-left has-abel-font-family has-upper-heading-font-size"><span class="dashicons dashicons-email-alt"></span>    '. esc_html__('support@example.com','soccer-club') .'</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<h2 class="wp-block-heading has-text-align-center has-background-color has-text-color has-teko-font-family" style="font-size:60px;font-style:normal;font-weight:700;letter-spacing:1px"><strong>'. esc_html__('We Have Best Sport','soccer-club') .'<br>'. esc_html__('WP Theme','soccer-club') .'</strong></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"background","fontSize":"upper-heading","fontFamily":"abel"} -->
<p class="has-text-align-center has-background-color has-text-color has-abel-font-family has-upper-heading-font-size">'. esc_html__('Online educational platform for digital skills where students aged between 6-17 makes their dreams come true by designing real projects','soccer-club') .'</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-font-size is-style-outline has-teko-font-family has-upper-heading-font-size" style="letter-spacing:1.5px"><a class="wp-block-button__link has-background-color has-text-color has-text-align-center wp-element-button" href="#" style="border-style:none;border-width:0px;border-radius:5px"><strong>'. esc_html__('Know More','soccer-club') .'</strong></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
