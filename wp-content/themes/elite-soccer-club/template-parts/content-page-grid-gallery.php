...
<article id="post-<?php the_ID(); ?>" <?php post_class('blog-post'); ?>>
    <?php
	    ...
	    $elite_soccer_club_elite_soccer_club_gallery_shortcode = get_post_gallery();

	    if (!empty($elite_soccer_club_gallery_shortcode)) {
	        // Display the gallery
	        echo '<div class="embedded-gallery">' . do_shortcode($elite_soccer_club_gallery_shortcode) . '</div>';
	    }
    ?>
