...
<section id="blog-content">
	<div class="featured-img">
		<div class="post-thumbnail">
			<?php
				if ( is_single() ) :
				    if ( true == get_theme_mod( 'elite_soccer_club_single_post_image_on_off', 'on' ) ) :
			...
			<div class="single-meta-box">
				<?php if ( is_single() ) : 
					if ( true == get_theme_mod( 'elite_soccer_club_single_meta_on_off', 'on' ) ) :
					if ( is_single() ) {
					...
					<ul class="meta-info list-inline">
					    <li class="posted-by"><i class="fa fa-user"></i> <?php esc_html_e('By', 'elite-soccer-club'); ?> <a href="<?php echo esc_url(get_author_posts_url($author_id)); ?>"><?php echo get_the_author_meta('display_name', $author_id); ?></a></li>
		...
		<div class="row">
			<div class="col-lg-8 col-md-8" >
				<?php if( have_posts() ): ?>					
					...
					<!-- Pagination -->
					    <?php if ( true == get_theme_mod( 'elite_soccer_club_single_post_pagination_on_off', 'on' ) ) : ?>
