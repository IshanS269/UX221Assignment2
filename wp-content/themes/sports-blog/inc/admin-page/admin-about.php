                    ...
                    <div class="theme-tab-wrapper">
                        <div class="theme-admin-getting-started theme-tab-content">
                            ...
                            <div class="theme-admin-item">
                                <div class="theme-admin-content">
                                    <h3 class="entry-title entry-title-small">
                                        <?php echo esc_html__('Advanced Typography and Color options', 'sports-blog'); ?>
                                    </h3>
                                    <div class="theme-admin-text">
                                        <?php echo esc_html__('Manage your typography options and color options', 'sports-blog'); ?>
                                    </div>
                                    <a href="<?php echo esc_url($site_url); ?>/themes/sports-blog-plus/" target="_blank"
                                       class="theme-admin-button">
                            ...
                            <div class="theme-admin-item">
                                <div class="theme-admin-content">
                                    <h3 class="entry-title entry-title-small">
                                        <?php echo esc_html__('Featured Blog Title', 'sports-blog'); ?>
                                    </h3>
                                    <div class="theme-admin-text">
                                ...
                                <li class="table-item">
                                    <ul class="table-data">
                                        <li>
                                            ...
                                            <?php echo esc_html__('One Click Demo Import', 'sports-blog'); ?>
                                            </span>
                                            <span>
                                            <?php echo esc_html__('A feature that allows you to import a pre-designed website template with a single click.', 'sports-blog'); ?>
                                            </span>
                                        </li>
                                        <li>
