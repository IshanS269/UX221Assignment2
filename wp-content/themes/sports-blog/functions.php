...
function sports_blog_scripts() {
	...
	wp_enqueue_style('sports-blog-style', get_stylesheet_uri(), array(), $theme_version );
    wp_style_add_data('sports-blog-style', 'rtl', 'replace');
    ...
    $custom_css = sports_blog_custom_css();
    if ( $custom_css ) {
        wp_add_inline_style( 'sports-blog-style', $custom_css );
    }
